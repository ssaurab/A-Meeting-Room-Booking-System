...
public class ClientControllerV1Test {
	...
	public void getAllClients_Returns_List_Of_Clients_And_HTTP_OK() throws Exception{
		...
		//Act and Assert
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/V1/clients").accept(MediaType.APPLICATION_JSON))
	...
	public void getClientById_Returns_Client_And_HTTP_OK_When_Id_Is_Valid() throws Exception{
		...
		//Act and Assert
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/V1/clients/{id}", id).accept(MediaType.APPLICATION_JSON))
			.andExpect(MockMvcResultMatchers.status().is(200))
			.andReturn();
	...
	public void addClient_Returns_Added_Client_And_Header_And_HTTP_OK_When_Client_Is_Valid() throws Exception{
		...
		//Act
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/V1/clients").contentType(MediaType.APPLICATION_JSON).content(toBeAddedJson))
		...
		//assertTrue(responseHeader.equals("/V1/clients"));
	}
	...
	public void deleteClientById_Returns_Client_And_HTTP_NO_CONTENT_When_Id_Is_Valid() throws Exception{
		...
		//Act and Assert
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.delete("/V1/clients/{id}", id).accept(MediaType.APPLICATION_JSON))
	...
	public void editClientById_Returns_Client_And_HTTP_OK_When_Id_And_Client_Are_Valid() throws Exception{
		...
		//Act and Assert
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.put("/V1/clients/{id}", id).contentType(MediaType.APPLICATION_JSON).content(toBeCopiedJson))
			.andExpect(MockMvcResultMatchers.status().is(200))
			.andReturn();
		String responseClient = result.getResponse().getContentAsString();
